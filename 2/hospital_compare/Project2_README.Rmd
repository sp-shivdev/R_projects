...
To create a function that returns the name of the hospital that has the best (i.e. lowest) 30-day mortality for the speci???ed outcome in that state.
...
To create a function that reads the outcome-of-care-measures.csv ???le and returns the name of the hospital that has the ranking speci???ed by an argument for a particular specified outcome
...
To create a function that reads returns a 2-column data frame containing the hospital in each state that has the ranking speci???ed for a specified outcome
